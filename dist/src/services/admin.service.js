...
const adminid_generate_1 = require("./adminid.generate");
...
const create = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const adminId = (0, adminid_generate_1.generateId)(name);
...
const changestatus = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!Object.values(type_interface_1.UserStatus).includes(status)) {
