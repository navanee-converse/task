...
const signupuser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userData = { userName: name, password: password, mail: mail, role: role };
        ...
        const fileData = { fileName: fileName, resume: resume, user_id: result.userId };
        yield userfile.create(fileData);
        response = {
            success: true,
            message: "User sign up successfully",
            data: { "User id": result.userId, "User name": result.userName, "Role": result.role, "Resume": fileData.fileName }
        };
...
const signinuser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (isUser !== null) {
            ...
            if (flag) {
                const header = (0, token_1.generateToken)({ id: isUser.userId, name: isUser.userName });
                response = {
                    success: true,
